...
// in pretend/test/application/bloc/timetable/timetable_bloc_test.dart.
...
import 'package:pretend/domain/usecases/set_timetable.dart' as _i9;
...
/// A class which mocks [SetTimetable].
///
/// See the documentation for Mockito's code generation for more information.
class MockSetTimetable extends _i1.Mock implements _i9.SetTimetable {
  MockSetTimetable() {
    _i1.throwOnMissingStub(this);
  }
