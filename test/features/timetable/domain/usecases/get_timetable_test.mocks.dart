...
// in pretend/test/features/timetable/domain/usecases/get_timetable_test.dart.
...
class MockTimetableRepositoryContract extends _i1.Mock
  ...
  @override
  _i4.Future<_i2.Either<_i5.Failure, Map<int, _i6.TimeSet>>> getTimetable(
          String? day) =>
      (super.noSuchMethod(Invocation.method(#getTimetable, [day]),
              returnValue:
                  Future<_i2.Either<_i5.Failure, Map<int, _i6.TimeSet>>>.value(
                      _FakeEither_0<_i5.Failure, Map<int, _i6.TimeSet>>()))
          as _i4.Future<_i2.Either<_i5.Failure, Map<int, _i6.TimeSet>>>);
  @override
